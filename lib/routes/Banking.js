 ...
 */
router.get('/', (req, res) => {
  BankingController.list(req, res);
});
...
router.get('/:id', (req, res) => {
  BankingController.show(req, res);
});
 ...
 */
router.post('/', (req, res) => {
  BankingController.create(req, res);
});
...
router.put('/:id', (req, res) => {
  BankingController.update(req, res);
});
...
router.delete('/:id', (req, res) => {
  BankingController.remove(req, res);
});
